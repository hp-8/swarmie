<template>
  <div class="process-page">
    <!-- Top Navbar -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">SWARMIE</div>
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          ...
          <div class="header-right">
            ...
            <div class="action-buttons">
                ...
                <button class="action-btn" @click="toggleFullScreen" :title="isFullScreen ? 'Exit Fullscreen' : 'Fullscreen Display'">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            <p class="waiting-text">Graph is being constructed</p>
            <p class="waiting-hint">Data will be displayed shortly...</p>
          </div>
        ...
        <div class="process-content">
          ...
          <div class="process-phase">
            ...
            <div class="detail-content">
              After uploading documents, the LLM analyzes the content and generates ontology structure (entity types + relationship types)
            </div>
          </div>
          ...
          <div class="process-phase">
            ...
            <div class="detail-content">
              Based on ontology, chunk documents and build graph via Zep API
            </div>
          </div>
          ...
          <div class="process-phase">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">Completed</div>
