...
Used to persist project state on the server, avoiding large data transfers between frontend APIs
"""
...
class Project:
    ...
    # Ontology info (filled after API 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph info (filled after API 2)
    graph_id: Optional[str] = None
    graph_build_task_id: Optional[str] = None
