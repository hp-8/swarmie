...
logger = get_logger('swarmie.simulation_runner')
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        real_base = os.path.realpath(cls.RUN_STATE_DIR)
        if not real_sim_dir.startswith(real_base + os.sep):
            raise ValueError(f"Path traversal detected in simulation_id: {simulation_id}")
